    ...
    <div class="space-y-8">
        ...
        @else
            <div class="rounded-xl border border-dashed border-line bg-surface p-12 text-center">
                <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-ink border border-line text-white0">
                ...
                <p class="text-xs text-white0 mt-1">{!! __('football.live.empty_hint', ['link' => '<a href="'.route('football.matchday').'" class="text-accent hover:underline">'.e(__('football.live.empty_link')).'</a>']) !!}</p>
            </div>
        @endif
    </div>
@endsection
