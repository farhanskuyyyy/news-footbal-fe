    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <form method="GET" action="{{ route('football.search') }}" class="space-y-3">
            <div class="flex items-center gap-2 rounded-xl border border-line bg-surface p-2 focus-within:border-line">
                <svg viewBox="0 0 24 24" fill="none" class="ml-2 h-5 w-5 text-muted"><circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="1.8"/><path d="M20 20l-3.5-3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
